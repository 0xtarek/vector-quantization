...
class Quantizer {
	...
	public static void compressImg(String inPath, String outPath, int vectorSize, int numberOfBits)
		...
		// out.writeObject((Object) new Integer(img.length));
		// out.writeObject((Object) new Integer(img[0].length));
		out.close();
...
//			}
		...
		// int yL=(Integer)in.readObject();
		// int xL=(Integer)in.readObject();
		int yL=528;
		int xL=384;
		int image[][] = new int[yL][xL];
		int i = 0, j = 0;
		...
		writeImage(image, null, outPath, yL, xL);
	}
